...
export const FirstAward = () => {
  return (
    <div className="flex items-start flex-col gap-6 w-[80%] mx-auto p-3 lg:p-0">
      <h5 className="text-purple font-bold">Team Lead / Frontend Engineer</h5>
      <span className="text-[14px]">
        Lead a team of four(4) to emerge among the winners of the Hackathon. We
        built a DP auto generator platform,{" "}
        <span className="font-semibold text-purple">Alphagen</span>, which
        increases users campaign/program reach by creating personalized DPs for
        their events.
      </span>
    </div>
  );
...
export const SecondAward = () => {
  return (
    <div className="flex items-start flex-col gap-6 w-[80%] mx-auto p-3 lg:p-0">
      <h5 className="text-purple font-bold">Technical Writer</h5>
      <span className="text-[14px]">
    ...
    >
      ...
      <div className="flex items-center gap-6 flex-col lg:flex-row h-[60%] lg:h-auto overflow-y-scroll lg:overflow-y-hidden overflow-x-hidden">
        ...
        <div className="flex items-center justify-center flex-col gap-6">
          {Award.map((award, index) => (
            <motion.div
              ...
              transition={{ duration: 1.5 }}
              key={index}
              className="h-[150px] w-full lg:w-[400px] bg-[#f2f6fc] flex items-center hover:cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-500 ease-in-out"
        ...
        <motion.div
          ...
          className="flex items-center justify-center h-[324px] w-[80%] lg:w-[400px] border-[4px] border-[#f2f6fc] shadow"
        >

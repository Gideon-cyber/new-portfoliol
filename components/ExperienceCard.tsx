...
const ExperienceCard = ({
  ...
  return (
    <article className="flex flex-col rounded-lg items-start space-y-2 flex-shrink-0 w-[93%] xl:w-[900px] snap-center bg-[#f2f6fc] px-2 lg:px-10 py-3 lg:py-6 lg:opacity-60 lg:hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden lg:mt-3">
      <motion.img
